 ...
 */
export const getRoleMembers = <ThrowOnError extends boolean = false>(options: Options<GetRoleMembersData, ThrowOnError>) => (options.client ?? client).get<GetRoleMembersResponses, GetRoleMembersErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const oidcInteractionControllerShowChangePasswordInteraction = <ThrowOnError extends boolean = false>(options: Options<OidcInteractionControllerShowChangePasswordInteractionData, ThrowOnError>) => (options.client ?? client).get<OidcInteractionControllerShowChangePasswordInteractionResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/interaction/{uid}/change-password',
    ...options
});

export const oidcInteractionControllerSubmitChangePassword = <ThrowOnError extends boolean = false>(options: Options<OidcInteractionControllerSubmitChangePasswordData, ThrowOnError>) => (options.client ?? client).post<OidcInteractionControllerSubmitChangePasswordResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/interaction/{uid}/change-password',
    ...options,
    headers: {
