...
export const getRoleMembersQueryKey = (options: Options<GetRoleMembersData>) => createQueryKey('getRoleMembers', options);
 ...
 */
export const getRoleMembersOptions = (options: Options<GetRoleMembersData>) => queryOptions<GetRoleMembersResponse, GetRoleMembersError, GetRoleMembersResponse, ReturnType<typeof getRoleMembersQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const oidcInteractionControllerShowChangePasswordInteractionQueryKey = (options: Options<OidcInteractionControllerShowChangePasswordInteractionData>) => createQueryKey('oidcInteractionControllerShowChangePasswordInteraction', options);

export const oidcInteractionControllerShowChangePasswordInteractionOptions = (options: Options<OidcInteractionControllerShowChangePasswordInteractionData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof oidcInteractionControllerShowChangePasswordInteractionQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await oidcInteractionControllerShowChangePasswordInteraction({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: oidcInteractionControllerShowChangePasswordInteractionQueryKey(options)
});

export const oidcInteractionControllerSubmitChangePasswordMutation = (options?: Partial<Options<OidcInteractionControllerSubmitChangePasswordData>>): UseMutationOptions<unknown, DefaultError, Options<OidcInteractionControllerSubmitChangePasswordData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<OidcInteractionControllerSubmitChangePasswordData>> = {
        mutationFn: async (fnOptions) => {
